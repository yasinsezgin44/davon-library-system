...
public class LibrarianController {
    ...
    public Response checkoutBook(@QueryParam("bookId") Long bookId, @QueryParam("memberId") Long memberId) {
        try {
            Loan loan = librarianService.checkoutBookForMember(bookId, memberId);
