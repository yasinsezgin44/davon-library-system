      ...
      <main className="lg:ml-64 p-4 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <LibraryCard className="p-8">
              <h2 className="text-2xl font-bold text-dark-gray mb-4">Recent Activity</h2>
              <div className="space-y-4">
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  <div className="w-2 h-2 bg-modern-teal rounded-full"></div>
                  <div className="flex-1">
                    <p className="text-sm font-medium text-dark-gray">"The Great Gatsby" returned by John Doe</p>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-dark-gray">New member "Jane Smith" registered</p>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  <div className="w-2 h-2 bg-modern-teal rounded-full"></div>
                  <div className="flex-1">
                    <p className="text-sm font-medium text-dark-gray">"1984" issued to Mike Johnson</p>
          ...
          <LibraryCard glassmorphism className="p-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-dark-gray mb-4">Modern Library Management</h2>
              <p className="text-dark-gray/70 mb-6 max-w-2xl mx-auto">
                Experience the future of library management with our intuitive interface, powerful features, and
                seamless user experience designed for modern libraries.
              </p>
