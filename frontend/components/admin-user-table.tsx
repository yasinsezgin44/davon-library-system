...
export function AdminUserTable() {
  ...
  const filteredAndSortedUsers = useMemo(() => {
    ...
    return filtered;
  }, [searchQuery, statusFilter, sortBy, sortOrder, users]);
            ...
            <tr className="border-b border-gray-200">
              ...
              >
                <div className="flex items-center space-x-1">
                  <span>User</span>
                  {sortBy === "name" && (
                    <span className="text-modern-teal">
                      {sortOrder === "asc" ? "↑" : "↓"}
                    </span>
                  )}
                </div>
              ...
              <th className="text-center py-3 px-4 font-medium text-dark-gray">
                Actions
              </th>
            </tr>
          </thead>
          <tbody>
            {paginatedUsers.map((user, index) => (
              ...
              >
                ...
                <td className="py-4 px-4">{getStatusBadge(user.active)}</td>
                <td className="py-4 px-4">
