// frontend/components/admin-kpi-cards.tsx
"use client";
...
import { countBooks, countUsers } from "@/lib/api";
    ...
    async function fetchData() {
      try {
        ...
        setKpiData([
          {
            title: "Total Books",
            value: booksResponse.count,
            change: 12.5, // placeholder
            changeType: "positive", // placeholder
            icon: BookOpen,
            color: "text-modern-teal",
            bgColor: "bg-modern-teal/10",
            suffix: "",
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      {kpiData.map((kpi, index) => {
        ...
        const isPositiveTrend =
          (kpi.title === "Overdue Loans" && kpi.change < 0) ||
          (kpi.title !== "Overdue Loans" && kpi.change > 0);
