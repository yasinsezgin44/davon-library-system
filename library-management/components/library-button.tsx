    ...
    return (
      <button
        className={cn(
          ...
          {
            "bg-modern-teal text-white hover:bg-modern-teal/90 active:bg-modern-teal/80": variant === "primary",
            "bg-warm-coral text-white hover:bg-warm-coral/90 active:bg-warm-coral/80": variant === "secondary",
            "border border-modern-teal text-modern-teal hover:bg-modern-teal hover:text-white": variant === "outline",
          },
          {
