 ...
 * @param {Props} props
 */
export var LinearProgress = function (inProps) {
    ...
    return oneSecondHasPassed ? (React.createElement(StyledProgress, __assign({ className: className }, rest))) : (React.createElement(Box, { my: 1, height: 4, component: "span", display: "block" }));
};
