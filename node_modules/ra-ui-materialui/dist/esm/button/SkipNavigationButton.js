...
export var SkipNavigationButton = function (inProps) {
    var props = useThemeProps({
        props: inProps,
        name: PREFIX,
    });
    return (React.createElement(StyledButton, __assign({ onClick: skipToContent, className: 'skip-nav-button', label: "ra.navigation.skip_nav", variant: "contained" }, props)));
};
