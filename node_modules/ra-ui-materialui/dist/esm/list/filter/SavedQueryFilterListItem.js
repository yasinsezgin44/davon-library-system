...
import { IconButton, ListItem, ListItemButton, ListItemText, ListItemSecondaryAction, styled, useThemeProps, } from '@mui/material';
...
export var SavedQueryFilterListItem = memo(function (inProps) {
    ...
    return (React.createElement(StyledListItem, { className: className, sx: sx, disablePadding: true },
        React.createElement(ListItemButton, { onClick: toggleFilter, selected: isSelected, disableGutters: true, className: SavedQueryFilterListItemClasses.listItemButton },
