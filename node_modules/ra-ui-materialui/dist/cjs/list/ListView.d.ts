...
export declare const ListView: <RecordType extends RaRecord<import("ra-core").Identifier> = any>(inProps: ListViewProps) => React.JSX.Element | null;
...
declare module '@mui/material/styles' {
    ...
    interface Components {
        RaList?: {
            ...
            styleOverrides?: ComponentsOverrides<Omit<Theme, 'components'>>['RaList'];
        };
    }
}
