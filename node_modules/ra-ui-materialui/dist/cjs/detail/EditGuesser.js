    ...
    (0, react_1.useEffect)(function () {
        if (record && !child) {
            ...
            var components = ['Edit']
                ...
                .sort();
            console.log("Guessed Edit:\n\nimport { ".concat(components.join(', '), " } from 'react-admin';\n\nexport const ").concat((0, inflection_1.capitalize)((0, inflection_1.singularize)(resource)), "Edit = () => (\n    <Edit>\n").concat(representation, "\n    </Edit>\n);"));
        }
    }, [record, child, resource, enableLog]);
    return React.createElement(EditView_1.EditView, __assign({}, rest), child);
};
