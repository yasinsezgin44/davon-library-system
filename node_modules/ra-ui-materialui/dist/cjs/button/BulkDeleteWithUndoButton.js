...
var BulkDeleteWithUndoButton = function (inProps) {
    ...
    var _d = (0, ra_core_1.useListContext)(), selectedIds = _d.selectedIds, onUnselectItems = _d.onUnselectItems;
    ...
    var _e = (0, ra_core_1.useDeleteMany)(), deleteMany = _e[0], isPending = _e[1].isPending;
