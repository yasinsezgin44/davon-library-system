 ...
 * @param {Props} props
 */
var LinearProgress = function (inProps) {
    var props = (0, styles_1.useThemeProps)({
        props: inProps,
        name: PREFIX,
    });
    var className = props.className, _a = props.timeout, timeout = _a === void 0 ? 1000 : _a, rest = __rest(props, ["className", "timeout"]);
    var oneSecondHasPassed = (0, ra_core_1.useTimeout)(timeout);
    return oneSecondHasPassed ? (React.createElement(StyledProgress, __assign({ className: className }, rest))) : (React.createElement(material_1.Box, { my: 1, height: 4, component: "span", display: "block" }));
};
exports.LinearProgress = LinearProgress;
// What? TypeScript loses the displayName if we don't set it explicitly
exports.LinearProgress.displayName = 'LinearProgress';
var PREFIX = 'RaLinearProgress';
var StyledProgress = (0, styles_1.styled)(material_1.LinearProgress, {
    name: PREFIX,
