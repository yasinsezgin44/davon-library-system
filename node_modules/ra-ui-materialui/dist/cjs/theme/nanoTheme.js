...
exports.nanoDarkTheme = exports.nanoLightTheme = void 0;
...
var lightPalette = __assign({ mode: 'light', primary: { main: '#00585C' }, secondary: { main: '#64B4B8' }, background: { default: '#f4f4f4' }, text: { primary: '#212b36' } }, alert);
...
exports.nanoLightTheme = createNanoTheme(lightPalette);
exports.nanoDarkTheme = createNanoTheme(darkPalette);
