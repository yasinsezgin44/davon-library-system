 ...
 */
var CheckboxGroupInput = function (inProps) {
    ...
    return (React.createElement(StyledFormControl, __assign({ component: "fieldset", margin: margin, error: fetchError || invalid, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className) }, sanitizeRestProps(rest)),
        React.createElement(material_1.FormLabel, { component: "legend", className: exports.CheckboxGroupInputClasses.label },
            React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired })),
        React.createElement(material_1.FormGroup, { row: row }, allChoices === null || allChoices === void 0 ? void 0 : allChoices.map(function (choice, index) { return (React.createElement(CheckboxGroupInputItem_1.CheckboxGroupInputItem, __assign({ key: (0, get_1.default)(choice, optionValue), choice: choice, id: id, onChange: handleCheck, options: options, optionText: optionText !== null && optionText !== void 0 ? optionText : (isFromReference ? getRecordRepresentation : 'name'), optionValue: optionValue, translateChoice: translateChoice !== null && translateChoice !== void 0 ? translateChoice : !isFromReference, value: value, labelPlacement: labelPlacement, inputRef: index === 0 ? ref : undefined, disabled: disabled || readOnly, readOnly: readOnly }, sanitizeRestProps(rest)))); })),
        renderHelperText ? (React.createElement(material_1.FormHelperText, { error: !!fetchError || !!error, className: exports.CheckboxGroupInputClasses.helperText },
