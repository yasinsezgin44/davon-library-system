 ...
 */
var AutocompleteInput = function (inProps) {
    ...
    var handleChange = (0, ra_core_1.useEvent)(function (newValue) {
        var _a, _b;
        if (multiple) {
    ...
    var finalOnBlur = (0, react_1.useCallback)(function (event) {
    ...
    var handleInputChange = (0, ra_core_1.useEvent)(function (event, newInputValue, reason) {
    ...
    var handleInputRef = (0, material_1.useForkRef)(field.ref, TextFieldProps === null || TextFieldProps === void 0 ? void 0 : TextFieldProps.inputRef);
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledAutocomplete, __assign({ className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), clearText: translate(clearText, { _: clearText }), closeText: translate(closeText, { _: closeText }), openOnFocus: true, openText: translate(openText, { _: openText }), id: id, isOptionEqualToValue: isOptionEqualToValue, filterSelectedOptions: true, disabled: disabled || readOnly, renderInput: function (params) {
                ...
                return (React.createElement(material_1.TextField, __assign({ name: field.name, label: React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resourceProp, isRequired: isRequired }), error: !!fetchError || invalid, helperText: renderHelperText ? (React.createElement(InputHelperText_1.InputHelperText, { error: (error === null || error === void 0 ? void 0 : error.message) ||
                            (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText: helperText })) : null, margin: margin, variant: variant, className: (0, clsx_1.default)((_a = {},
                        _a[exports.AutocompleteInputClasses.textField] = true,
                        _a[exports.AutocompleteInputClasses.emptyLabel] = label === false || label === '',
                        _a)) }, params, TextFieldProps, { InputProps: mergedTextFieldProps, size: size, inputRef: handleInputRef })));
...
var StyledAutocomplete = (0, styles_1.styled)(material_1.Autocomplete, {
    ...
    return (_b = {},
        ...
        _b["& .".concat(exports.AutocompleteInputClasses.emptyLabel, " .MuiOutlinedInput-root legend")] = {
            width: 0,
        },
        _b);
});
