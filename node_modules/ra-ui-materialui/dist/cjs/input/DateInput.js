...
var DateInput = function (_a) {
    ...
    var _c = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, resource: resource, source: source, validate: validate, disabled: disabled, readOnly: readOnly, format: format }, rest)), field = _c.field, fieldState = _c.fieldState, id = _c.id, isRequired = _c.isRequired;
    ...
    React.useEffect(function () {
        ...
        var hasNewValueFromForm = ((_a = localInputRef.current) === null || _a === void 0 ? void 0 : _a.value) !== field.value &&
            !(((_b = localInputRef.current) === null || _b === void 0 ? void 0 : _b.value) === '' && field.value == null);
    ...
    var handleChange = (0, ra_core_1.useEvent)(function (event) {
        if (onChange) {
            onChange(event);
        }
    ...
    var handleFocus = (0, ra_core_1.useEvent)(function (event) {
        if (onFocus) {
            onFocus(event);
        }
        hasFocus.current = true;
    });
    var handleBlur = (0, ra_core_1.useEvent)(function () {
