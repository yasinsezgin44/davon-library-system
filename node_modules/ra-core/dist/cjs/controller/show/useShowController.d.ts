 ...
 * };
 */
export declare const useShowController: <RecordType extends RaRecord<import("../../types").Identifier> = any, ErrorType = Error>(props?: ShowControllerProps<RecordType, ErrorType>) => ShowControllerResult<RecordType, ErrorType>;
