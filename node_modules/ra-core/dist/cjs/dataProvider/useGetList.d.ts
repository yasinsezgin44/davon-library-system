 ...
 * };
 */
export declare const useGetList: <RecordType extends RaRecord<import("../types").Identifier> = any, ErrorType = Error>(resource: string, params?: Partial<GetListParams>, options?: UseGetListOptions<RecordType, ErrorType>) => UseGetListHookValue<RecordType>;
