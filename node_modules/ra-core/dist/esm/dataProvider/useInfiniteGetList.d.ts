 ...
 * };
 */
export declare const useInfiniteGetList: <RecordType extends RaRecord<import("../types").Identifier> = any, ErrorType = Error>(resource: string, params?: Partial<GetListParams>, options?: UseInfiniteGetListOptions<RecordType, ErrorType>) => UseInfiniteGetListHookValue<RecordType, ErrorType>;
