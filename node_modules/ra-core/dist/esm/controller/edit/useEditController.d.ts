 ...
 * }
 */
export declare const useEditController: <RecordType extends RaRecord<import("../../types").Identifier> = any, ErrorType = Error>(props?: EditControllerProps<RecordType, ErrorType>) => EditControllerResult<RecordType, ErrorType>;
